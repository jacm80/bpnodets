import {MigrationInterface, QueryRunner, getConnection, getRepository, Table} from "typeorm";
...
export class CreateAdminUser1564495946035 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        // await getConnection().transaction(async  transactionalEntityManager => {
            ...
            // await groupRepository.save(groupAdmin);
    
            // const groupUser = new Group();
            // groupAdmin.description = 'user';
            // await groupRepository.save(groupUser);
